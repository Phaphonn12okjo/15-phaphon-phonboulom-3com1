...
![Arduino Uno Board Diagram](./images/Arduino_Uno_Board_Diagram.png)
...
![USB Cable](./images/USB_Cable.png)
![USB Cable Diagram](./images/USB_Cable_Diagram.png)
...
![Jumper Wires MTM](./images/Jumper_Wires_MTM.png)
...
![Jumper Wires MTF](./images/Jumper_Wires_MTF.png)
...
![Jumper Wires FTF](./images/Jumper_Wires_FTF.png)
...
![9V Battery Connector](./images/9V_Battery_Connector.png)
![9V Battery Connector Diagram](./images/9V_Battery_Connector_Diagram.png)
...
![Red LEDs](./images/Red_LEDs.png)
![Yellow LEDs](./images/Yellow_LEDs.png)
![Blue LEDs](./images/Blue_LEDs.png)
...
![RGB Module](./images/RGB_Module.png)
![RGB Module Diagram](./images/RGB_Module_Diagram.png)
...
![Resistor 220 Ohm](./images/Resistor_220_Ohm.png)
![Resistor 1k 10k Ohm](./images/Resistor_1K_10K_Ohm.png)
![Resistor Diagram](./images/Resistor_Diagram.png)
...
![Push Button](./images/Push_Button.png)
![Push Button Diagram](./images/Push_Button_Diagram.png)
...
![Potentiometer Diagram](./images/Potentiometer_Diagram.png)
...
![Active Buzzer](./images/Active_Buzzer.png)
![Active Buzzer Diagram](./images/Active_Buzzer_Diagram.png)
...
![Passive Buzzer](./images/Passive_Buzzer.png)
![Passive Buzzer Diagram](./images/Passive_Buzzer_Diagram.png)
...
![16x2 LCD Display](./images/16x2_LCD_display.png)
![16x2 LCD Display Diagram](./images/16x2_LCD_display_Diagram.png)
...
![I2C Serial Adapter Board Module](./images/I2C_Serial_Adapter_board_module.png)
![I2C Serial Adapter Board Module Diagram](./images/I2C_Serial_Adapter_board_module_Diagram.png)
...
![7-segment Display](./images/7-segment_display.png)
![7-segment Display Diagram](./images/7-segment_display_Diagram.png)
...
![4-Digit 7-Segment Display](./images/4-Digit_7-Segment_Display.png)
![4-Digit 7-Segment Display Diagram](./images/4-Digit_7-Segment_Display_Diagram.png)
...
![8x8 Dot Matrix Display](./images/8x8_Dot_Matrix_display.png)
![8x8 Dot Matrix Display Diagram](./images/8x8_Dot_Matrix_display_Diagram.png)
...
![DHT11 Diagram](./images/DHT11_Diagram.png)
...
ມັນຜະລິດໂວນສົ່ງອອກ $10mV$ ຕໍ່ $1^\circ C$. ຕົວຢ່າງ: ຖ້າອຸນຫະພູມແມ່ນ $25^\circ C$, ໂວນສົ່ງອອກຈະແມ່ນ $250mV$ ($0.25V$). Arduino ອ່ານໂວນນີ້ຜ່ານ Pin ອະນາລັອກ ແລະ ປ່ຽນມັນເປັນອຸນຫະພູມທີ່ແທ້ຈິງໃນລະຫັດ.

### 3. **ຂໍ້ມູນລາຍລະອຽດອຸປະກອນ**

![LM35](./images/LM35.png)
![LM35 Diagram](./images/LM35_Diagram.png)
...
![Tilt Sensor](./images/Tilt_sensor_x2.png)
![Tilt Sensor Diagram](./images/Tilt_sensor_x2_Diagram.png)
...
![LDR](./images/LDR.png)
![LDR Diagram](./images/LDR_Diagram.png)
...
![PIR Sensor](./images/PIR.png)
![PIR Sensor Diagram](./images/PIR_Diagram.png)
...
![Ultrasonic Module](./images/Ultrasonic.png)
![Ultrasonic Module Diagram](./images/Ultrasonic_Diagram.png)
...
![Sound Sensor](./images/Sound_Sensor.png)
![Sound Sensor Diagram](./images/Sound_Sensor_Diagram.png)
...
![Water Sensor](./images/Water_Sensor.png)
![Water Sensor Diagram](./images/Water_Sensor_Diagram.png)
...
![Flame Sensor](./images/Flame_Sensor.png)
![Flame Sensor Diagram](./images/Flame_Sensor_Diagram.png)
...
![RFID Module](./images/RFID_Module.png)
![RFID Module Diagram](./images/RFID_Module_Diagram.png)
...
![RFID Tag](./images/RFID_Tag.png)
![RFID Tag Diagram](./images/RFID_Tag_Diagram.png)
...
![Infrared Receiver](./images/Infrared_receiver.png)
![Infrared Receiver Diagram](./images/Infrared_receiver_Diagram.png)
...
![Joystick Module Diagram](./images/Joystick_Module_Diagram.png)
...
![4x4 Matrix Keyboard Module](./images/4x4_Matrix_Keyboard_Module.png)
![4x4 Matrix Keyboard Module Diagram](./images/4x4_Matrix_Keyboard_Module_Diagram.png)
...
![Servo Motor Diagram](./images/Servo_Motor_Diagram.png)
...
![Stepper Motor Diagram](./images/Stepper_Motor_Diagram.png)
...
![Stepper Motor Driver Board](./images/Stepper_Motor_Driver_Board.png)
![Stepper Motor Driver Board Diagram](./images/Stepper_Motor_Driver_Board_Diagram.png)
...
![Real-time Clock Module DS1302](./images/Real-time_Clock_Module_DS1302.png)
![Real-time Clock Module DS1302 Diagram](./images/Real-time_Clock_Module_DS1302_Diagram.png)
...
![74HC595 Chip](./images/74HC595_Chip.png)
![74HC595 Chip Diagram](./images/74HC595_Chip_Diagram.png)
